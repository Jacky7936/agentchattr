...
def main():
    ...
    from app import store, rules, summaries, jobs, room_settings, registry, router as app_router, agents as app_agents, commander_ledger as app_commander_ledger, session_engine, session_store
    import mcp_bridge
    ...
    mcp_bridge.commander_ledger = app_commander_ledger
